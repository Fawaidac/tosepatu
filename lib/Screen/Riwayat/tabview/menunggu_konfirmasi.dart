...
class MenungguKonfirmasi extends StatefulWidget {
  const MenungguKonfirmasi({Key key}) : super(key: key);

  @override
  State<MenungguKonfirmasi> createState() => _KonfirmasiState();
}

class _KonfirmasiState extends State<MenungguKonfirmasi>
  ...
  void initState() {
    ...
    super.initState();
    listdata = apiServices.getRiwayatStatus("Menunggu Konfirmasi");
  }
